...
crystal count_sum_free_sets_v1_plain.cr -n ${num_iterations} > "../exec_times/Crystal/${cpu_name}_v1_crystal.txt"

./process_execution_time_file.bash "../exec_times/Crystal/${cpu_name}_v1_crystal.txt"
